...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BoardingPassInfo fakeBpi = FakeDataUtils.generateFakeBoardingPassInfo();
        displayBoardingPassInfo(fakeBpi);
    }
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        String hoursAndMinutesUntilBoarding = getString(R.string.countDownFormat, hoursUntilBoarding, minuteLessHoursUntilBoarding);
